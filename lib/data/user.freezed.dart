...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String name, int yearOfBirth, String description});
}
...
class _$_User with DiagnosticableTreeMixin implements _User {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'User(email: $email, name: $name, yearOfBirth: $yearOfBirth, description: $description)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, name, yearOfBirth, description);
